...
- (instancetype)initWithFrame:(CGRect)frame withButtonNames:(NSArray *)array{
    ...
    if (self) {
        ...
        for (int i = 0; i < array.count; i ++) {
            ...
            [bu setTitleColor:HWColor(63, 202, 125) forState:(UIControlStateSelected)];
            [bu setBackgroundColor:HWColor(247, 247, 247)];
            bu.tag = 1000 + i;
            [self addSubview:bu];
...
//        [self addSubview:grayLineView];
        ...
        UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(buttonWidth, 10, 1, 24)];
        lineView.backgroundColor = [UIColor grayColor];
        [self addSubview:lineView];
        
        UIView *lineView1 = [[UIView alloc]initWithFrame:CGRectMake(2 * buttonWidth, 10, 1, 24)];
